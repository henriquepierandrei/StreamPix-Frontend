...
import {BicepsFlexed, Gauge, Laugh, Mars, Mic, Music, Sparkles, Venus, Volume2 } from "lucide-react";
      ...
      <div className="voice-selector-container">
        ...
        {showSettings && (
          <div className="settings-panel">
            ...
            <div className="setting-group">
              <label className="setting-label">
                <span className="setting-icon"><Laugh /></span>
                Estilo da Voz
              </label>
              <select 
              ...
              >
                ...
                <option value="fearful">Assustado</option>
                <option value="gentle">Gentil</option>
                <option value="chat">Conversando</option>
                <option value="newscast">Noticiário</option>
